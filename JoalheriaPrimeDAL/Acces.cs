...
namespace JoalheriaPrimeDAL
{
    ...
    public class Acces
    {
        ...
        public static void ExecuteNonQuery(IDbCommand pCommand, bool registrolog = true)
        {
            int tentativa = 1;
            bool retry = false;
       ...
       public static T ExecuteScalar<T>(string command)
        ...
        {
            string EncryptionKey = user + "#d3M@r1ª#";
        ...
        public static EventHandler ShowDialogMessage;

        public static EventHandler CloseDialogMessage;
        ...
        public static DataSet ExecuteReader(IDbCommand pCommand)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    IDbDataAdapter da = new SqlDataAdapter((SqlCommand)pCommand);
